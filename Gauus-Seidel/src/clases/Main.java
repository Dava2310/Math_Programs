...
public class Main {
    ...
    public static void main(String args[]){
        ...
        System.out.println("Bienvenido al programa Gauss-Seidel");
        ...
        if (filas == (columnas - 1)){
            ...
            System.out.print("Ingrese la cantidad de erorr: ");
    ...
    static float[] gaussSeidel(float[][] matriz, int filas, int columnas, float error){
        ...
        do{
            ...
            condicion = verificacionSalida(vectorSolucion, vectorSolucionAnterior, error, filas);
            
            // Ingresando estos valores en el vector solucion anterior
            for (int K = 0; K < filas; K++){
                vectorSolucionAnterior[K] = vectorSolucion[K];
            }
    ...
    // Verificacion de la condicion de salida
    static boolean verificacionSalida(float[] vectorActual, float[] vectorAnterior, float error, int filas){
        
        for (int i = 0; i < filas; i++){
            
            if (Math.abs(vectorActual[i] - vectorAnterior[i]) > error){
